...
int main() {
	...
	rk data[3];
	strcpy(data[0].nama,"ROY");
	data[0].norek = 222222222;
	strcpy(data[0].bank,"BRI");
	data[0].saldo = 3000000;
	strcpy(data[1].nama,"ONY");
	data[1].norek = 333333333;
	strcpy(data[1].bank,"BNI");
	data[1].saldo = 4500000;
	strcpy(data[2].nama,"NIA");
	data[2].norek = 444444444;
	strcpy(data[2].bank,"BCA");
	data[2].saldo = 4000000;
	
	almt rum[3];
	strcpy(rum[0].jalan,"JL. raya Rungkut");
	strcpy(rum[0].kota,"Surabaya ");
	strcpy(rum[0].provinsi,"Jawa Timur  ");
	strcpy(rum[1].jalan,"JL. raya soekarno");
